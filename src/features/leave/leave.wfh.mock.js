...
const REASONS = ["Home internet setup", "Family care", "Focused deliverable work", "Weather/commute disruption", "Medical recovery"];

export function genWfhRequests() {
...
export const WFH_REQUESTS = genWfhRequests();
